...
class correlation_functions:
    def __init__(self,Gamma_m:torch.Tensor,N_f:int):
        self.c_dagger_c_mat = self.c_dagger_c_expectation_value_matrix_creation(Gamma_m, N_f)
        self.c_dagger_c_dagger_mat = self.c_dagger_c_dagger_expectation_value_matrix_creation(Gamma_m, N_f)
        self.c_c_mat = self.c_c_expectation_value_matrix_creation(Gamma_m, N_f)
        self.c_c_dagger_mat = self.c_c_dagger_expectation_value_matrix_creation(Gamma_m, N_f)
        self.correlation_mat_for_non_gaussian_parameters = self.correlation_matrix_creation(Gamma_m, N_f)
    ...
    def c_c_expectation_value_matrix_creation(self,Gamma_m:torch.Tensor,N_f:int)->torch.Tensor:
        """
        -----------------------------
        -----------------------------
        DESCRIPTION
    ...
    def c_dagger_c_dagger_expectation_value_matrix_creation(self,Gamma_m:torch.Tensor,N_f:int)->torch.Tensor:
        """
        -----------------------------
        -----------------------------
        DESCRIPTION
    ...
    def density_density_anticommutator_connected_correlation_matrix_creation(self,Gamma_m:torch.Tensor,N_f:int)->torch.Tensor:
        """
        -----------------------------
        -----------------------------
        DESCRIPTION
        ...
        """ 
        c_dagger_c_expectation_value_mat = self.c_dagger_c_mat
        c_c_expectation_value_mat = self.c_c_mat
        c_dagger_c_dagger_expectation_value_mat = self.c_dagger_c_dagger_mat
        c_c_dagger_expectation_value_mat = self.c_c_dagger_mat
    ...
    def correlation_matrix_creation(self,Gamma_m:torch.Tensor,N_f:int)->torch.Tensor:
