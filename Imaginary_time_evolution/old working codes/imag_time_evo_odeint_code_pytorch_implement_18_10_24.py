...
import numpy as np
from Imaginary_time_evolution import imaginary_time_evolution_functions_pytorch_implement_18_10_24 as itef
...
def imag_time_evo_model_solve_ivp(t:np.ndarray,y:np.ndarray,input_variables:cdf.input_variables):
    ...
    np.save("d_delta_R_dt.npy",d_delta_R_dt)
    np.save("d_Gamma_b_dt.npy",d_Gamma_b_dt)
    np.save("d_Gamma_m_dt.npy",d_Gamma_m_dt)
